...
x1, y1, x2, y2 = 250, 200, 1900, 1456 ##crop the front camera
...
dyads = ["a05_c05", "a06_c06"] ##which dyad folder are we looping?
...
strt_solo = [78, 521] ##the seconds at which the FRONT video STARTED recording the SOLO condition
strt_sbr = [357, 53] ##the seconds at which the FRONT video STARTED recording the SBR condition
...
if len(main) != len(dyads):
    ...
    for dyad in dyads:
        ...
        ## (b)Extract and render video for the solo condition:
        ## The front video
        ...
        ## (c)Extract and render video for the sbr condition:
        ## The side video
